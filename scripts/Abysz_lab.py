...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        source_folder = gr.Textbox(label="Reference frames folder (The frames you used to make the AI video)", value="J:\FULL")
        source_folder_value = source_folder.value
        generated_folder = gr.Textbox(label="Generated frames folder", value="d:/usuario/Documents/CONTROLNET/DEFLIKER/Maingradio/Gen")
        ...
        slider4 = gr.Slider(minimum=0, maximum=10, value=4, step=0.1, label="DFI Deghost")
    ...
    def run_Abysz_lab(self, slider1, slider2, slider3, slider4, slider5):
        ...
        slider4_val = slider4.value
        slider5_val = slider5.value
        ...
        for file in os.listdir(source_folder_value):
            if file.endswith(".jpg") or file.endswith(".jpeg") or file.endswith(".png"):
                ...
                img.save(os.path.join("./extensions/Abysz-lab/scripts/Run/Source", file), "jpeg", quality=100)
        for file in os.listdir(generated_folder_value):
            if file.endswith(".jpg") or file.endswith(".jpeg") or file.endswith(".png"):
                img = Image.open(os.path.join(generated_folder_value, file))
                img.save(os.path.join("./extensions/Abysz-lab/scripts/Run/Gen", file))
        ...
        gen_dir = "./extensions/Abysz-lab/scripts/Run/Gen" # ruta de la carpeta "Source"
        ...
        gen_files = os.listdir("./extensions/Abysz-lab/scripts/Run/Gen")
        if gen_files:
            first_gen_file = gen_files[0]

            # Copiar el archivo a la carpeta "Output" y reemplazar si ya existe
            output_file = "./extensions/Abysz-lab/scripts/Run/Output/" + first_gen_file
            shutil.copyfile("./extensions/Abysz-lab/scripts/Run/Gen/" + first_gen_file, output_file)
        ...
        for file in files:
          ...
          img = cv2.imread("./extensions/Abysz-lab/scripts/Run/MaskD/" + file)
        
          # Invertir la imagen usando la función bitwise_not()
          img_inv = cv2.bitwise_not(img)
          
          kernel_size = slider4.value
          ...
          cv2.imwrite("./extensions/Abysz-lab/scripts/Run/MaskD/" + file, img_out)
          
        # Definir la carpeta donde están los archivos
        carpeta = "./extensions/Abysz-lab/scripts/Run/MaskD"
        blur_kernel = slider5.value
        ...
        while True:
            ...
            dissolve = 100 if loop_count % slider1.value != 0 else slider2.value
        ...
        render_button.click(fn=lambda: run_Abysz_lab(slider1, slider2, slider3, slider4, slider5))
        #render_button.click(fn=run_Abysz_lab)
